...
Following examples show how to switch from effective percentage rates (APR) to nominal 
percentage rates, that is $i^m \to i$ and vice versa.
...
amount and indicator variables regarding the life status of the insured. This is the present value benefit 
